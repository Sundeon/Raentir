...
- **Vítězství**: Vítězství znamená, že souboj přežil alespoň jeden hráč. Hráči místo klasických exp dostanou dočasný pozitivní trait (tento má vypravěč u sebe) a bod znalosti.
  
  * **Body znalosti**: Mohou hráči proměnit v deckbuildingu za nové karty nebo se nějakých karet zbavit (//fixní cena třeba 1 bod).
